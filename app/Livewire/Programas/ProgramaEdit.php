...
class ProgramaEdit extends ModalComponent
{
	...
	{
		return view('livewire.programas.programa-edit', [
	...
	public function updatePost()
	{
		...
		try {
			...
			flash()->success('Actualizado', [], 'Programa');
			$this->closeModal();
			$this->dispatch('refreshprogramas');
		} catch (\Exception $e) {
			flash()->danger('No se pudo actualizar', [], 'Programa');
		}
	}
}
